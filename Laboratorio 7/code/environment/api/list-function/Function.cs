...
namespace PollyNotesAPIList
{
    ...
    {
        private void AddAnnotation(string userId)
        {
            AWSXRayRecorder.Instance.BeginSubsegment("List all notes");
